...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // هنا يمكن إضافة معالجة النموذج مثل إرسال البيانات إلى الخادم
    ...
    <Layout>
      <div className="bg-amber-50 py-12">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl md:text-4xl font-bold text-center mb-12">تواصل معنا</h1>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            <div>
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h2 className="text-2xl font-bold text-amber-600 mb-6">معلومات التواصل</h2>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">777492635</p>
                      <a href="https://wa.me/777492635" className="text-green-600 font-medium flex items-center mt-1">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@sheingolden.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">صنعاء - شارع القيادة - بجوار كاك بنك</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8">
                  ...
                  <div className="bg-amber-50 p-4 rounded-lg">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>1:00 ظهراً - 9:00 مساءً</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8">
                  ...
                  <div className="flex space-x-4 space-x-reverse">
                    <a href="#" className="bg-amber-100 text-amber-600 p-3 rounded-full hover:bg-amber-200 transition-colors">
            ...
            {/* Contact Form */}
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h2 className="text-2xl font-bold text-amber-600 mb-6">راسلنا</h2>
